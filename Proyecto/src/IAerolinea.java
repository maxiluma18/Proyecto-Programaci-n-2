...
public interface IAerolinea {
	 ...
	 * Cuando un cliente compre un pasaje es un Cliente (pasajero) y queda
	 * registrado en el vuelo correspondiente.
	 */
	void registrarCliente(int dni, String nombre, String telefono);

	/**
	 * - 3
	 * Se ingresa un aeropuerto con los datos que lo identifican. Estos aeropuertos
	 * son los que deberán corresponder
	...
	/**
	 * - 4
	 * El origen y destino deben ser aeropuertos con país=”Argentina” y ya
	 * registrados en la aerolinea.
	 * La fecha es la fecha de salida del vuelo.
	 * Los asientos se considerarán numerados correlativamente empezando con clase
	 * Turista y terminando con la clase Ejecutivo.
	 ...
	 * ejemplo--> 103-PUB
	 * Si al validar los datos no se puede registrar, se deberá lanzar una
	 * excepción.
	 */
	 ...
	 * Los asientos se considerarán numerados correlativamente empezando con clase
	 * Turista, siguiendo por Ejecutiva
	 ...
	 * idem precios.
	 * - escalas = nombre del aeropuerto donde hace escala. Si no tiene escalas,
	 * esto es un arreglo vacío.
	 * Tripulantes es la cantidad de tripulantes del vuelo.
	 ...
	 * Se supone que se cuenta con todos los jets necesarios para trasladar todos
	 * los acompañantes.
	 * Se usara la cantidad de jets (necesarios) para el calculo del costo total del
	 * Vuelo.
	 * IMPORTANTE; Se toma un sólo código para la compra aunque se necesiten mas de
	 * un jet.
	...
	/**
	 * - 7
	 * Dado el código del vuelo, devuelve un diccionario con los asientos aún
	 ...
	 * Los pasajeros que compran pasajes deben estar registrados como clientes, con
	 * todos sus datos, antes de realizar la compra. Devuelve el codigo del pasaje y
	 * lanza una excepción si no puede venderlo.
	 * aOcupar indica si el asiento que será ocupado por el cliente, o si solo lo
	 * compro para viajar más cómodo.
	 * Devuelve un código de pasaje único que se genera incrementalmente sin
	 * distinguir entre tipos de vuelos.
	 */
	int venderPasaje(int dni, String codVuelo, int nroAsiento, boolean aOcupar);

	/**
	 * - 11.
	 * devuelve una lista de códigos de vuelos. que estén entre fecha dada y hasta
	 * una semana despues. La lista estará vacía si no se encuentran vuelos
	 ...
	 * Los pasajes se reprograman a vuelos con igual destino, no importa el numero
	 * del asiento pero
	 ...
	 * Los pasajes no reprogramados se eliminan. Y se devuelven los datos de la
	 * cancelación, indicando
	 * los pasajeros que se reprogramaron y a qué vuelo, y los que se cancelaron por
	 * no tener lugar.
	 * Devuelve una lista de Strings con este formato : “dni - nombre - telefono -
	 * [Codigo nuevo vuelo|CANCELADO]”
	 * --> Ejemplo:
	...
	/**
	 * - 14
	 * devuelve el total recaudado por todos los viajes al destino pasado por
	 * parámetro.
	 * IMPORTANTE: Se debe resolver en O(1).
	 */
	 ...
	 * Formato del String: CodigoVuelo - Nombre Aeropuerto de salida - Nombre
	 * Aeropuerto de llegada -
	 * fecha de salida - [NACIONAL /INTERNACIONAL / PRIVADO + cantidad de jets
	 * necesarios].
	 * --> Ejemplo:
