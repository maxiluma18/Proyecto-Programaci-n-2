...
// aerolinea.registrarAeropuerto("Aeroparque", "Argentina", "Provincia de Buenos
// Aires",
// "Av. Costanera Rafael Obligado");
// aerolinea.registrarAeropuerto("Ezeiza", "Argentina", "Provincia de Buenos
// Aires",
// "Autopista Riccheri km 33.5");
// aerolinea.registrarAeropuerto("Bariloche", "Argentina", "Provincia de Río
// Negro", "Ruta Nacional 237");

// // Registrar aeropuertos internacionales (Europa y América)
// aerolinea.registrarAeropuerto("Charles de Gaulle", "Francia", "Departamento
// de Val-d'Oise",
// "95700 Roissy-en-France");
// aerolinea.registrarAeropuerto("JFK", "Estados Unidos", "Estado de Nueva
// York", "Queens, NY 11430");
...
// String codVueloInternacional =
// aerolinea.registrarVueloPublicoInternacional("Ezeiza",
// "Charles de Gaulle",
// "20/11/2024", 12, 6000, 3, preciosInternacional, cantAsientosInternacional,
// escalas);
...
// System.out.println("Vuelo Internacional Registrado: " +
// codVueloInternacional);
