...
public class Principal {
        public static void main(String[] args) {
                ...
                // }
                // if (error)
                // throw new RuntimeException("Consultar asientos disponibles del vuelo privado
                ...
                String codVuelo = aerolinea.registrarVueloPublicoInternacional("Charles de Gaulle", "Ezeiza",
                                "15/12/2024", 8,
                                2000, 3,
                                precios, cantAsientos, escalas1);

                String codVuelo3String = aerolinea.registrarVueloPublicoInternacional("Charles de Gaulle", "Ezeiza",
                                "15/12/2024", 8,
                                2000, 3,
                                precios, cantAsientos, escalas1);
                System.out.println(
                                "Total recaudado en vuelos a : "
                                                + aerolinea.totalRecaudado("Ezeiza"));
                for (int i = 1; i < 141; i++) {
                        int dni = 10000000 + i;
                        aerolinea.registrarCliente(dni, "Pasajero " + (i + 1), "011-1234-" + (5670 + i));
                ...
                List<String> bobis = aerolinea.cancelarVuelo(codVuelo);
                System.out.println(bobis);
                System.out.println(
                                "Total recaudado en vuelos a : "
                                                + aerolinea.totalRecaudado("Ezeiza"));
                System.out.println(aerolinea.asientosDisponibles(codVuelo3String));
                aerolinea.cancelarPasaje(10000001, codVuelo3String, 1);
                System.out.println(aerolinea.asientosDisponibles(codVuelo3String));
                System.out.println(aerolinea.totalRecaudado("Ezeiza"));
        }
}
