...
public class Principal {
    public static void main(String[] args) {
        ...
        String codVueloNacional = aerolinea.registrarVueloPublicoNacional("Aeroparque", "Bariloche", "15/11/2024", 8,
        ...
        System.out.println(
                "Total recaudado en vuelos a 'Charles de Gaulle': " + aerolinea.totalRecaudado("Charles de Gaulle"));
